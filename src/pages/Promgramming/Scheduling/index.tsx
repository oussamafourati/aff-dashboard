...
import UpcommingEvents from '../Scheduling/UpCommingEvents';
...
const Calendar = () => {
    ...
    const validation: any = useFormik({
        ...
        validationSchema: Yup.object({
            title: Yup.string().required("Please Enter Trip Name"),
            Model: Yup.string().required("Please Select Your Trip Model"),
    ...
    document.title = "Calendar | School Administration";
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    ...
                    <Row>
                        ...
                        <Col xl={3}>
                            <Button variant="primary" className="w-100" id="btn-new-event" onClick={toggle}><i className="mdi mdi-plus"></i> Create New Trip</Button>
                            <div className="mt-4">
                                <h5 className="mb-1 fs-18">Recent Added Trips</h5>
                                <p className="text-muted">Don't miss scheduled events</p>
                                <div className="search-box mb-3">
                                    <input type="text" className="form-control" autoComplete="off" id="searchResultsList" placeholder="Search Trips..." onChange={(e) => searchCustomer(e)} />
                            ...
                            <Card className="bg-primary-subtle border-0 overflow-hidden">
                                ...
                                {/* <Card.Body className="p-4 z-1 position-relative">
                                    ...
                                    <Link to="/orders-list-view" className="btn btn-primary btn-hover">Create Trip</Link>
                                </Card.Body> */}
                            </Card>
                        </Col>
                    </Row>
            ...
            <Modal show={modal} id="event-modal" onHide={toggle} centered>
                <Modal.Header className="p-3 bg-info-subtle" closeButton>
                    <Modal.Title>
                        {!!isEdit ? (event.title || "Edit Trip") : "Add Trip"}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body className="p-4">
                    <Form className={!!isEdit ? "needs-validation view-event" : "needs-validation"} name="event-form" id="form-event"
                        ...
                        <Row className="event-form">
                            <Col xs={12}>
                                {/* <div className="mb-3">
                                    ...
                                    <Form.Control as="select"
                                        ...
                                        <option value="bg-warning-subtle">Pending</option>
                                        <option value="bg-warning-subtle">On Road</option>
                                        <option value="bg-success-subtle">Done</option>
                            ...
                            <Col xs={12}>
                                <div className="mb-3">
                                    <Form.Label className="form-label">Trip Name</Form.Label>
                                    <Form.Control className={!!isEdit ? "form-control d-none" : "form-control d-block"} placeholder="Enter Trip name" type="text" name="title" id="event-title" onChange={validation.handleChange} onBlur={validation.handleBlur} value={validation.values.title || ""}
                            ...
                            <Col xs={12}>
                            <div className="mb-3">
                                    <Form.Label className="form-label">Trip Model</Form.Label>
                                    <Form.Control as="select"
                                        className={!!isEdit ? "form-select d-none" : "form-select d-block"} name="category" id="event-category" type="select" onChange={validation.handleChange} onBlur={validation.handleBlur} value={validation.values.category || ""}>
                                    ...
                                    {validation.touched.Model && validation.errors.Model ? (<Form.Control.Feedback type="invalid">{validation.errors.Model}</Form.Control.Feedback>) : null}
                                </div>
