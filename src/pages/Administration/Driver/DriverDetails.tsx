      ...
      <div className="page-content">
            ...
            <Row>
              <div className="hstack gap-0">
                <Col lg={3}>
                  ...
                  >
                    <img
                      src={`http://localhost:3000/driverAffiliateFiles/profileImages/${driverLocation.state.profile_image}`}
                      alt=""
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/driverAffiliateFiles/licenseFiles/${driverLocation.state.driver_license}`}
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/driverAffiliateFiles/dqcFiles/${driverLocation.state.dqc}`}
                onLoadSuccess={onDocumentLoadSuccess}
              >
                <Page pageNumber={1} />
              </Document>
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/driverAffiliateFiles/dbsCheckFiles/${driverLocation.state.dbscheck}`}
                onLoadSuccess={onDocumentLoadSuccess}
              >
                <Page pageNumber={1} />
              </Document>
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/driverAffiliateFiles/contractFiles/${driverLocation.state.contract}`}
                onLoadSuccess={onDocumentLoadSuccess}
              >
                <Page pageNumber={1} />
              </Document>
