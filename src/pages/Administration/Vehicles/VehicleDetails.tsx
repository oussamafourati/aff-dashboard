      ...
      <div className="page-content">
              ...
              <Row className="sticky-side-div m-4">
                <Col lg={12} className="mt-4">
                  <div className="bg-white rounded-4 position-relative ribbon-box overflow-hidden">
                    <img
                      src={`http://localhost:3000/VehicleAffiliateFiles/vehicleImages/${LocationVehicle.state.vehicle_images}`}
                      // src={productsImg31}
                      alt=""
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/VehicleAffiliateFiles/insuranceFiles/${LocationVehicle.state.insurance_file}`}
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/VehicleAffiliateFiles/motFiles/${LocationVehicle.state.mot_file}`}
                onLoadSuccess={onDocumentLoadSuccess}
              >
                <Page pageNumber={1} />
              </Document>
        ...
        >
          ...
          <Modal.Body className="p-4">
            ...
            <div>
              <Document
                file={`http://localhost:3000/VehicleAffiliateFiles/taxFiles/${LocationVehicle.state.tax_file}`}
                onLoadSuccess={onDocumentLoadSuccess}
              >
                <Page pageNumber={1} />
              </Document>
