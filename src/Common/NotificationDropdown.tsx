...
import { useGetAllQuoteQuery } from 'features/quotes/quotesSlice';
...
const NotificationDropdown = () => {
    ...
    let result = allquotes.filter((quotes)=> quotes.affiliate_id === user?._id!)
   let resultNewJobs = result.filter((newJobs)=> newJobs.progress === "Pending")
    return (
        <React.Fragment>
